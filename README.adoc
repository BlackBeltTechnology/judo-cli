...
# Build the binary (simple method)
...
=== Comprehensive Build with Embedded Frontend

The `build.sh` script provides a complete build process that:
...
- Asset embedding preparation
- Go compilation with proper ldflags
- Test execution
