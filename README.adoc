...
image:https://img.shields.io/github/actions/workflow/status/BlackBeltTechnology/judo-cli/docs-release.yml?style=for-the-badge&logo=github-actions&label=Documentation[Documentation Status]
...
# Windows x86_64
# Download and extract judo_Windows_x86_64.zip from releases page
----
